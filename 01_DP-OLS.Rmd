...
# res_se will hold the standard errors of the regression coefficients (if X'X is invertable, else NA)
...
# Draw (d^2 + d) / 2 values (lower/upper triangle plus diagonal) from the Laplace distribution with b.
...
# Get standard errors of the regression coefficients from the noisy covariance matrix (if possible, throws a warning if X'X is not invertable.)
...
# Function to calculate the sensitivity of the covariance matrix from PSIlence Library
